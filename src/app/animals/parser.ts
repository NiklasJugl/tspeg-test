...
* INPUT GRAMMAR:
* parse:= WHAT SPACE* DOES SPACE* THE SPACE* animal={ANIMAL} SPACE* SAY SPACE* QUESTIONMARK SPACE* sound={SOUND} EOF
* ANIMAL:= COW | FOX | CAT | DOG | WORD
* SOUND:= MOO | YIF | MEOW | WOF | WORD
* WHAT:='What'
* DOES:='does'
* THE:= 'the'
* SAY:= 'say'
...
export class Parser {
        ...
        return this.run<parse>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.loop<SPACE>(() => this.matchSPACE($$dpth + 1, $$cr), true) !== null
                    && this.matchQUESTIONMARK($$dpth + 1, $$cr) !== null
                    && this.loop<SPACE>(() => this.matchSPACE($$dpth + 1, $$cr), true) !== null
    ...
    public matchSOUND_4($$dpth: number, $$cr?: ErrorTracker): Nullable<SOUND_4> {
        return this.matchWOF($$dpth + 1, $$cr);
    }
    ...
    public matchQUESTIONMARK($$dpth: number, $$cr?: ErrorTracker): Nullable<QUESTIONMARK> {
    ...
    public matchMEOW($$dpth: number, $$cr?: ErrorTracker): Nullable<MEOW> {
        return this.regexAccept(String.raw`(?:moew)`, $$dpth + 1, $$cr);
    }
    public matchWOF($$dpth: number, $$cr?: ErrorTracker): Nullable<WOF> {
        return this.regexAccept(String.raw`(?:wof)`, $$dpth + 1, $$cr);
    }
